...
$showFinished = showTransaction("SELECT * FROM t_header
        ...
        <div class="row pt-2">
            <div class="col-4 ms-auto pb-2">
                <form class="d-flex" action="" method="POST">
                    <input class="form-control me-2 input_search_data_finished" type="search" placeholder="Search data in the table" aria-label="Search" name="keyword">
                    <button class="btn btn_search_data_finished" type="submit" name="search">Search</button>
                </form>
            </div>
            <div class="col-12">
                <table class="table table-bordered table_finished table-hover">
                    ...
                    <tbody>
                        <?php $no = 1; ?>
                        <?php foreach ($showFinished as $finished) : ?>
                            <?php if ($finished['laundry_status'] == 'Finished') : ?>
                                <tr>
                                    <td>
                                        <p class="txt_table_finished"><?php echo $no ?></p>
                                    </td>
                                    <td>
                                        <p class="txt_table_finished"><?php echo $finished['transaction_code'] ?></p>
                                    </td>
                                    <td>
                                        <p class="txt_table_finished"><?php echo $finished['full_name'] ?></p>
                                    </td>
                                    <td>
                                        <p class="txt_table_finished"><?php echo date('d-m-Y', strtotime($finished['date_order'])) ?></p>
                                    </td>
                                    <td>
                                        <p class="txt_table_finished"><?php echo $finished['laundry_status'] ?></p>
                                    </td>
                                    <td>
                                        <p class="txt_table_finished"><?php echo date('d-m-Y', strtotime($finished['created_at_header'])) ?></p>
                                    </td>
                                    <td>
                                        <p class="txt_table_on_process"><?php echo $finished['created_by_header'] ?></p>
                                    </td>
                                    <td>
                                        <p class="txt_table_on_process"><?php echo date('d-m-Y', strtotime($finished['updated_at_header'])) ?></p>
                                    </td>
                                    <td>
