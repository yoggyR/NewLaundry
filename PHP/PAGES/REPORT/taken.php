                        ...
                        <?php foreach ($showTaken as $taken) : ?>
                            <?php if ($taken['laundry_status'] == 'Taken') : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="main.php?page=oft details&id=<?php echo $taken['pk_id_header'] ?>" class="btn btn_finished_details" type="button" title="Finished details"><img src="../../ASSET/ICON/PACKAGE/iconmonstr-id-card-1.svg" class="img_btn_finished_details"></a>
                                    </td>
                                </tr>
                                <?php $no++; ?>
                            <?php endif; ?>
